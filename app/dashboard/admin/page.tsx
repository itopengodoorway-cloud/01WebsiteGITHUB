...
import { ShieldAlert, Users, Video, CreditCard, MessageSquare } from "lucide-react";
  ...
  return (
    <div className="px-4 py-8 md:px-10 md:py-12 max-w-7xl mx-auto">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4 mb-12">
        ...
        <AdminStatCard title="Pending Reviews" value="18" icon={<Video className="h-5 w-5" />} color="bg-orange-50 text-orange-600" />
        <AdminStatCard title="Unread Messages" value="5" icon={<MessageSquare className="h-5 w-5" />} color="bg-purple-50 text-purple-600" />
      </div>

      <div className="rounded-[48px] bg-white border border-[color:var(--border)] p-10">
        <h3 className="text-xl font-bold text-[color:var(--secondary)] mb-8">Recent Activity</h3>
