...
-- FIXED: Corrected table creation order and added IF NOT EXISTS
-- ===========================================
...
-- ===========================================
-- 2. LIBRARIES TABLE (no dependencies)
-- ===========================================
...
-- ===========================================
-- 3. VIDEOS TABLE (depends on libraries)
-- ===========================================
...
-- ===========================================
-- 4. HANDICAP_HISTORY TABLE (depends on profiles)
-- ===========================================
...
-- ===========================================
-- 5. VIDEO_PROGRESS TABLE (depends on profiles and videos)
-- ===========================================
...
-- ===========================================
-- 6. SUBSCRIPTIONS TABLE (depends on profiles)
-- ===========================================
...
-- ===========================================
-- 7. CHAT_MESSAGES TABLE (depends on profiles)
-- ===========================================
...
-- ===========================================
-- 8. MESSAGE_ATTACHMENTS TABLE (depends on chat_messages)
-- ===========================================
...
-- TEST DATA INSERTION
-- ===========================================
-- Insert test libraries (only if they don't exist)
...
AND NOT EXISTS (
    SELECT 1 FROM videos v WHERE v.title = 'Basic Swing Fundamentals'
);
...
SELECT
    ...
    'Master the art of putting with pro tips',
    'dQw4w9WgXcQ',
    'https://img.youtube.com/vi/dQw4w9WgXcQ/maxresdefault.jpg',
    '8:15'
FROM libraries l
...
AND NOT EXISTS (
    SELECT 1 FROM videos v WHERE v.title = 'Advanced Putting Techniques'
);