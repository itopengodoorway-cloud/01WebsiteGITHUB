...
import { Play, ArrowLeft, Clock, Video, Lock, ChevronRight } from "lucide-react";
    ...
    <div className="px-4 py-8 md:px-10 md:py-12 max-w-7xl mx-auto">
      ...
      <div className="grid gap-6">
        {videos?.map((video, i) => (
          <div 
            key={video.id}
            className="group rounded-[32px] bg-white border border-[color:var(--border)] p-6 md:p-8 hover:border-[color:var(--primary)] transition-all flex flex-col md:flex-row gap-8 items-center"
          >
            {/* Thumbnail Area */}
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-6">
                <button className="flex items-center gap-2 text-xs font-black uppercase tracking-widest text-[color:var(--primary)] hover:underline">
